...
def parse_args():
  ...
  global REFERENCE_DATA_DIR
  global BENCHMARK_RESULT_DIR
  parser = argparse.ArgumentParser()
  # creating another argument so we can specify the path when running the script
  ...
  # accessing the path as a string and storing it under the global variables
  cur_path = str(args.models_path)
  TEST_DATA_DIR = cur_path
  REFERENCE_DATA_DIR = cur_path
  BENCHMARK_RESULT_DIR = cur_path
  return args
